...
class DodaniTest extends CalendarTestCase{
    ...
    public function testDodaniShipping(){
		$testTime1 = new Calendar('29.04.2016 11:00');
		...
		$testTime2 = new Calendar('29.04.2016 14:01');
		...
		$testTime3 = new Calendar('29.04.2016 15:12');
		...
		$testTime9 = new Calendar('29.04.2016 23:25');
		...
		$testTime10 = new Calendar('29.04.2016 15:25');
